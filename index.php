...
<html class="no-js" lang="en" dir="ltr">
    ...
    <body>
        ...
        <section class="hero text-center">
            <img src="/img/Hero_Box-opt.jpg" title="N95 Mask Giveaway" />
        </section>
                    ...
                    <div class="small-12 large-12 cell">
                        ...
                        <form class="email-form" method="POST" action="#">
                            <div class="input-group">
                              ...
                              <input class="input-group-field" type="email" name="email" id="email" placeholder="Please enter your e-mail address">
                              <div class="input-group-button">
                                <a href="#" class="button" id="submit-button">SUBMIT</a>
                              </div>
                            </div>
                            <p class="fine-print">
        ...
        <section class="prizes-container">
            ...
            <div class="text-center title-section wow slideInUp">
                <h2 class="text-uppercase strong">Giveaway Prizes</h2>
                <hr class="title-deco" />
                <hr class="top" />
                <hr class="bottom" />
            </div>
                ...
                <div class="grid-x grid-padding-x">
                    ...
                    <div class="small-6 medium-6 large-6 cell">
                        <ul class="no-bullet social-media">
                            ...
                            <li>
                                <a href="https://twitter.com/full30tv" title="Full30's Twitter" target="_blank">
                                    <i class="fab fa-twitter-square"></i>
                                </a>
                            </li>

                            <li>
                                <a href="https://www.youtube.com/user/FULL30TV" title="Full30's YouTube" target="_blank">
                                    <i class="fab fa-youtube-square"></i>
                                </a>
                            </li>

                            <li>
                                <a href="https://www.instagram.com/full30/" title="Full30's Instagram" target="_blank">
